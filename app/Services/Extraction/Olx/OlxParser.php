...
class OlxParser
{
    ...
    public function parseDetail(array|string $payload): array
    {
        ...
        if (! is_array($item) || array_is_list($item)) {
            throw new SourceUnavailableException('Listing detail payload did not contain a listing object.', 'PARSER_FAILURE');
        }
    ...
    private function extractList(array $decoded): array
    {
        ...
        throw new SourceUnavailableException('Search payload did not contain a listing collection.', 'PARSER_FAILURE');
    }
}
