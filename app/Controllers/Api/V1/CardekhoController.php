...
class CardekhoController extends BaseController
{
    public function listings(): ResponseInterface
    {
        ...
        try {
            $result = (new ListingSearchService())->search('cardekho', $this->request->getGet());
            ...
            log_message('error', 'Unhandled CarDekho search error: {message}', [
    ...
    public function detail(string $listingId): ResponseInterface
    {
        ...
        try {
            $result = (new ListingDetailService())->byId('cardekho', $listingId, $this->freshOption());
            $metrics = $result['metrics'];
            ...
            log_message('error', 'Unhandled CarDekho detail error: {message}', [
                'message' => $exception->getMessage(),
            ]);
    ...
    public function detailByUrl(): ResponseInterface
    {
        ...
        try {
            $result = (new ListingDetailService())->byUrl('cardekho', $url, $this->freshOption());
            $metrics = $result['metrics'];
            ...
            log_message('error', 'Unhandled CarDekho URL lookup error: {message}', [
                'message' => $exception->getMessage(),
            ]);
