...
class OlxController extends BaseController
{
    public function listings(): ResponseInterface
    {
        ...
        try {
            $result = (new ListingSearchService())->search('olx', $this->request->getGet());
            ...
            log_message('error', 'Unhandled listing search error: {message}', [
    ...
    public function detail(string $listingId): ResponseInterface
    {
        ...
        try {
            $result = (new ListingDetailService())->byId('olx', $listingId, $this->freshOption());
            $metrics = $result['metrics'];
            ...
            log_message('error', 'Unhandled listing detail error: {message}', [
                'message' => $exception->getMessage(),
            ]);
    ...
    public function detailByUrl(): ResponseInterface
    {
        ...
        try {
            $result = (new ListingDetailService())->byUrl('olx', $url, $this->freshOption());
            $metrics = $result['metrics'];
            ...
            log_message('error', 'Unhandled listing URL lookup error: {message}', [
                'message' => $exception->getMessage(),
            ]);
