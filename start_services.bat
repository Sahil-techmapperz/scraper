@echo off
title OLX Real-Time Data Scraper Services
color 0A

echo ========================================================
echo   Starting OLX Real-Time Data Scraper Stack
echo ========================================================
echo.
...
start "Python Extractor (Port 8000)" cmd /k "cd /d %~dp0 && extractor\.venv\Scripts\uvicorn extractor.main:app --host 127.0.0.1 --port 8000"
